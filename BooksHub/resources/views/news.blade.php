                    ...
                    <div class="news-standard-wrapper">
                        <div class="news-standard-items">
                            <div class="news-thumb">
                                <img src="{{asset('assets/users/assets/img/news/post-1.jpg')}}" alt="img">
                                <div class="post">
                        ...
                        <div class="news-standard-items">
                            <div class="news-thumb">
                                <img src="{{asset('assets/users/assets/img/news/post-2.jpg')}}" alt="img">
                                <div class="post">
                        ...
                        <div class="news-standard-items">
                            <div class="news-thumb">
                                <img src="{{asset('assets/users/assets/img/news/post-3.jpg')}}" alt="img">
                                <div class="post">
