                            ...
                            <div class="tab-pane fade show active" id="pills-arts" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="shop-details.html"><img src="{{asset('assets/users/assets/img/book/01.png')}}" alt="img"></a>
                                                <ul class="post-box">
                                                    <li>
                                                        Hot
                                                    </li>
                                                ...
                                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                                    ...
                                                    <li>
                                                        <a href="shop-cart.html">
                                                            <img class="icon" src="{{asset('assets/users/assets/img/icon/shuffle.svg')}}"
                                                                alt="svg-icon">
                                                        </a>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/06.png')}}" alt="img"></a>
                                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                                    <li>
                                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                                    </li>
