                        ...
                        <div class="blog-post-details">
                                    ...
                                    <div class="row g-4 mt-4">
                                        <div class="col-lg-6">
                                            <div class="details-image">
                                                <img src="{{asset('assets/users/assets/img/news/post-5.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="details-image">
                                                <img src="{{asset('assets/users/assets/img/news/post-6.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="comments-area">
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-4 pb-5">
                                    <div class="image">
                                        <img src="{{asset('assets/users/assets/img/news/comment.png')}}" alt="image">
                                    </div>
                                    <div class="content">
                                        <div
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-5 pb-5">
                                    <div class="image">
                                        <img src="{{asset('assets/users/assets/img/news/comment-2.png')}}" alt="image">
                                    </div>
                                    <div class="content">
                                        <div
                                            class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                ...
                                <div class="recent-post-area">
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="{{asset('assets/users/assets/img/news/pp3.jpg')}}" alt="img">
                                        </div>
                                    ...
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="{{asset('assets/users/assets/img/news/pp4.jpg')}}" alt="img">
                                        </div>
                                        <div class="recent-content">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="{{asset('assets/users/assets/img/news/pp5.jpg')}}" alt="img">
                                        </div>
                                        <div class="recent-content">
                                            <ul>
                                                <li>
