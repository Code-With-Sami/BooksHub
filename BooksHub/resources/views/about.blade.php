...
<!-- Mirrored from gramentheme.com/html/bookle/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2025 04:24:33 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="UTF-8">
    ...
    <!--<< Favcion >>-->
    <link rel="shortcut icon" href="{{assets('assets/users/assets/img/favicon.png')}}">
    <!--<< Bootstrap min.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/bootstrap.min.css')}}">
    <!--<< All Min Css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/all.min.css')}}">
    <!--<< Animate.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/animate.css')}}">
    <!--<< Magnific Popup.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/magnific-popup.css')}}">
    <!--<< MeanMenu.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/meanmenu.css')}}">
    <!--<< Swiper Bundle.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/swiper-bundle.min.css')}}">
    <!--<< Nice Select.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/nice-select.css')}}">
    <!--<< Icomoon.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/icomoon.css')}}">
    <!--<< Main.css >>-->
    <link rel="stylesheet" href="{{assets('assets/users/assets/css/main.css')}}">
</head>
...
<body>
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.html">
                                <img src="{{assets('assets/users/assets/img/logo/black-logo.svg')}}" alt="logo-img">
                            </a>
                        </div>
                            ...
                            <div class="header-left">
                                <div class="logo">
                                    <a href="index.html" class="header-logo">
                                        <img src="{{assets('assets/users/assets/img/logo/white-logo.svg')}}" alt="logo-img">
                                    </a>
                                </div>
                                    ...
                                    <div class="header-humbager ml-30">
                                        <a class="sidebar__toggle" href="javascript:void(0)">
                                            <div class="bar-icon-2">
                                                <img src="{{assets('assets/users/assets/img/icon/icon-13.svg')}}" alt="img">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="identityBox">
                        <div class="form-wrapper">
                            ...
                            <div>
                                <a class="another-option" href="https://www.google.com/">
                                    <img src="{{assets('assets/users/assets/img/google.png')}}" alt="google">
                                    Continue With Google
                                </a>
                            </div>
                            <div>
                                <a class="another-option another-option-two" href="https://www.facebook.com/">
                                    <img src="{{assets('assets/users/assets/img/facebook.png')}}" alt="google">
                        ...
                        <div class="banner">
                            ...
                            <button type="button" class="theme-btn rounded-0 register-btn" data-bs-toggle="modal"
                                ...
                                Account</button>
                            <div class="loginBg">
                                <img src="{{assets('assets/users/assets/img/signUpbg.jpg')}}" alt="signUpBg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="identityBox">
                        ...
                        <div class="banner">
                            ...
                            <button type="button" class="theme-btn rounded-0 register-btn" data-bs-toggle="modal"
                                ...
                                Account</button>
                            <div class="signUpBg">
                                <img src="{{assets('assets/users/assets/img/registrationbg.jpg')}}" alt="signUpBg">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="breadcrumb-wrapper">
        <div class="book1">
            <img src="{{assets('assets/users/assets/img/hero/book1.png')}}" alt="book">
        </div>
        <div class="book2">
            <img src="{{assets('assets/users/assets/img/hero/book2.png')}}" alt="book">
        </div>
        <div class="container">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="about-image">
                            <img src="{{assets('assets/users/assets/img/about.jpg')}}" alt="img">
                            <div class="video-box">
        ...
        <div class="container">
            <div class="cta-banner-wrapper section-padding bg-cover"
                ...
                <div class="book-shape">
                    <img src="{{assets('assets/users/assets/img/book-shape.png')}}" alt="shape-img">
                </div>
                <div class="girl-shape float-bob-x">
                    <img src="{{assets('assets/users/assets/img/girl-shape-2.png')}}" alt="shape-img">
                </div>
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('assets/users/assets/img/testimonial/01.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="{{assets('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="logo">
                                    <img src="{{assets('assets/users/assets/img/testimonial/logo1.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('assets/users/assets/img/testimonial/02.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="{{assets('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
                                ...
                                <div class="logo">
                                    <img src="{{assets('assets/users/assets/img/testimonial/logo2.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('assets/users/assets/img/testimonial/03.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="{{assets('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('assets/users/assets/img/testimonial/04.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="{{assets('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/01.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/02.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/03.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/04.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/05.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="{{assets('assets/users/assets/img/team/06.jpg')}}" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="{{assets('assets/users/assets/img/team/shape-img.png')}}" alt="img">
                                </div>
    ...
    <footer class="footer-section footer-bg">
        ...
        <div class="footer-widgets-wrapper">
            <div class="plane-shape float-bob-y">
                <img src="{{assets('assets/users/assets/img/plane-shape.png')}}" alt="img">
            </div>
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="footer-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <ul class="brand-logo wow fadeInRight" data-wow-delay=".5s">
                        <li>
                            <a href="contact.html">
                                <img src="{{assets('assets/users/assets/img/visa-logo.png')}}" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="{{assets('assets/users/assets/img/mastercard.png')}}" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="{{assets('assets/users/assets/img/payoneer.png')}}" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="{{assets('assets/users/assets/img/affirm.png')}}" alt="img">
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <!--<< All JS Plugins >>-->
    <script src="{{assets('assets/users/assets/js/jquery-3.7.1.min.js')}}"></script>
    <!--<< Viewport Js >>-->
    <script src="{{assets('assets/users/assets/js/viewport.jquery.js')}}"></script>
    <!--<< Bootstrap Js >>-->
    <script src="{{assets('assets/users/assets/js/bootstrap.bundle.min.js')}}"></script>
    <!--<< Nice Select Js >>-->
    <script src="{{assets('assets/users/assets/js/jquery.nice-select.min.js')}}"></script>
    <!--<< Waypoints Js >>-->
    <script src="{{assets('assets/users/assets/js/jquery.waypoints.js')}}"></script>
    <!--<< Counterup Js >>-->
    <script src="{{assets('assets/users/assets/js/jquery.counterup.min.js')}}"></script>
    <!--<< Swiper Slider Js >>-->
    <script src="{{assets('assets/users/assets/js/swiper-bundle.min.js')}}"></script>
    <!--<< MeanMenu Js >>-->
    <script src="{{assets('assets/users/assets/js/jquery.meanmenu.min.js')}}"></script>
    <!--<< Magnific Popup Js >>-->
    <script src="{{assets('assets/users/assets/js/jquery.magnific-popup.min.js')}}"></script>
    <!--<< Wow Animation Js >>-->
    <script src="{{assets('assets/users/assets/js/wow.min.js')}}"></script>
    <!-- Gsap -->
    <script src="{{assets('assets/users/assets/js/gsap.min.js')}}"></script>
    <!--<< Main.js >>-->
    <script src="{{assets('assets/users/assets/js/main.js')}}"></script>
</body>
