                                    ...
                                    <ul class="brand-logo">
                                        <li>
                                            <a href="checkout.html">
                                                <img src="{{asset('assets/users/assets/img/PayPal.png')}}" alt="img">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="checkout.html">
                                                <img src="{{asset('assets/users/assets/img/GooglePay.png')}}" alt="img">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="checkout.html">
                                                <img src="{{asset('assets/users/assets/img/Mastercard2.png')}}" alt="img">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
