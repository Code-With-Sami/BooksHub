        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/05.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/05.jpg')}}" alt="img">
                            <div class="post-box">
                                Books Store
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/06.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/06.jpg')}}" alt="img">
                            <div class="post-box">
                                Educations
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/07.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/07.jpg')}}" alt="img">
                            <div class="post-box">
                                Romance
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/08.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/08.jpg')}}" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/13.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/13.jpg')}}" alt="img">
                            <div class="post-box">
                                Romance
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/14.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/14.jpg')}}" alt="img">
                            <div class="post-box">
                                Adnenture
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/15.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/15.jpg')}}" alt="img">
                            <div class="post-box">
                                Educations
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items style-2 mt-0">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/16.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/16.jpg')}}" alt="img">
                            <div class="post-box">
                                Books Store
                            </div>
