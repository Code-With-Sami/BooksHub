            ...
            <div class="swiper book-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/01.png')}}" alt="img"></a>
                                <ul class="post-box">
                                    <li>
                                        Hot
                                    </li>
                                ...
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    ...
                                    <li>
                                        <a href="shop-cart.html">
                                            <img class="icon" src="{{asset('assets/users/assets/img/icon/shuffle.svg')}}" alt="svg-icon">
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{{asset('assets/users/assets/img/testimonial/client-1.png')}}" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/02.png')}}" alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{{asset('assets/users/assets/img/testimonial/client-2.png')}}" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/03.png')}}" alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{{asset('assets/users/assets/img/testimonial/client-3.png')}}" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/04.png')}}" alt="img"></a>
                                <ul class="post-box">
                                    <li>
                                        -12%
                                    </li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{{asset('assets/users/assets/img/testimonial/client-4.png')}}" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="{{asset('assets/users/assets/img/book/05.png')}}" alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{{asset('assets/users/assets/img/testimonial/client-5.png')}}" alt="img">
                                        </span>
                ...
                <div class="swiper book-catagories-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="{{asset('assets/users/assets/img/book-categori/01.png')}}" alt="img">
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="{{asset('assets/users/assets/img/book-categori/02.png')}}" alt="img">
                                    <div class="circle-shape">
                                        <img src="{{asset('assets/users/assets/img/book-categori/circle-shape.png')}}" alt="shape-img">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="{{asset('assets/users/assets/img/book-categori/03.png')}}" alt="img">
                                    <div class="circle-shape">
                                        <img src="{{asset('assets/users/assets/img/book-categori/circle-shape.png')}}" alt="shape-img">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="{{asset('assets/users/assets/img/book-categori/04.png')}}" alt="img">
                                    <div class="circle-shape">
                                        <img src="{{asset('assets/users/assets/img/book-categori/circle-shape.png')}}" alt="shape-img">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="{{asset('assets/users/assets/img/book-categori/05.png')}}" alt="img">
                                    <div class="circle-shape">
                                        <img src="{{asset('assets/users/assets/img/book-categori/circle-shape.png')}}" alt="shape-img">
                                    </div>
                                </div>
            ...
            <div class="book-shop-wrapper">
                ...
                <div class="cta-shop-box">
                    ...
                    <div class="girl-shape">
                        <img src="{{asset('assets/users/assets/img/girl-shape.png')}}" alt="shape-img">
                    </div>
                    <div class="circle-shape">
                        <img src="{{asset('assets/users/assets/img/circle-shape.png')}}" alt="shape-img">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                        ...
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/01.png')}}" alt="img">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/02.png')}}" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/03.png')}}" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/04.png')}}" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/05.png')}}" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="{{asset('assets/users/assets/img/top-book/06.png')}}" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        ...
                                        <div class="icon">
                                            <img class="shape" src="{{asset('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="logo">
                                    <img src="{{asset('assets/users/assets/img/testimonial/logo1.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                ...
                                <div class="logo">
                                    <img src="{{asset('assets/users/assets/img/testimonial/logo2.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('{{asset('assets/users/assets/img/testimonial/04.jpg')}}');">
                                        <div class="icon">
                                            <img class="shape" src="{{asset('assets/users/assets/img/testimonial/shape.svg')}}" alt="img">
                                        </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items">
                        <div class="news-image">
                            <img src="{{asset('assets/users/assets/img/news/12.jpg')}}" alt="img">
                            <img src="{{asset('assets/users/assets/img/news/12.jpg')}}" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
