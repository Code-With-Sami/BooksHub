...
@section('content')
    ...
    <div class="breadcrumb-wrapper">
        <div class="book1">
            <img src="{{assets('assets/img/hero/book1.png')}}" alt="book">
        </div>
        <div class="book2">
            <img src="{{assets('assets/img/hero/book2.png')}}" alt="book">
        </div>
        <div class="container">
                                        ...
                                        <td>
                                            <span class="d-flex gap-5 align-items-center">
                                                <a href="wishlist.html" class="remove-icon">
                                                    <img src="{{assets('assets/img/icon/icon-9.svg')}}" alt="img">
                                                </a>
                                                <span class="cart">
                                                    <img src="{{assets('assets/img/shop-cart/01.png')}}" alt="img">
                                                </span>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="d-flex gap-5 align-items-center">
                                                ...
                                                <span class="cart">
                                                    <img src="{{assets('assets/img/shop-cart/02.png')}}" alt="img">
                                                </span>
                                                <span class="cart-title">
                                    ...
                                    <tr>
                                        <td>
                                            <span class="d-flex gap-5 align-items-center">
                                                ...
                                                <span class="cart">
                                                    <img src="{{assets('assets/img/shop-cart/03.png')}}" alt="img">
                                                </span>
                                                <span class="cart-title">
