  ...
  <!--end top header-->
   ...
   <aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
      <div class="logo-icon">
        <img src="{{asset('admin/assets/images/BooksHubLogoPortrait1.png')}}" class="logo-img" alt="">
      </div>
      <div class="logo-name flex-grow-1">
        <h5 class="mb-0">BooksHub</h5>
      </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
              ...
              <ul>
                <li><a href="{{url('admin-users')}}"><i class="material-icons-outlined">arrow_right</i>Users</a>
                <li><a href="{{url('create-users')}}"><i class="material-icons-outlined">arrow_right</i>Create User</a>
                </li>
              </ul>
          </li>
          <li>
          ...
          <li>
              <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Competittions</div>
              </a>
              <ul>
                <li><a href="{{ route('admin.competitions.create') }}"><i class="material-icons-outlined">arrow_right</i>Create Competitions</a>
                <li><a href="{{ route('admin.competitions.index') }}"><i class="material-icons-outlined">arrow_right</i>View Competitions</a>
                </li>
              </ul>
          </li>
          <li>
...
<!--end sidebar-->
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="staticBackdrop">
    <div class="offcanvas-header border-bottom h-70">
      <div class="">
        <h5 class="mb-0">Dashboard Customizer</h5>
        <p class="mb-0">Customize your Dashboard</p>
      </div>
      <a href="javascript:;" class="primaery-menu-close" data-bs-dismiss="offcanvas">
        <i class="material-icons-outlined">close</i>
      </a>
