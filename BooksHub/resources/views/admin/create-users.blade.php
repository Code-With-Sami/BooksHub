            ...
            <form class="row g-3 needs-validation" action="{{ route('storeusers') }}" method="POST" novalidate>
                  @csrf 
									<div class="col-md-6">
										...
										<input type="text" name="firstName" class="form-control" id="bsValidation1" placeholder="First Name" required>
									...
									<div class="col-md-6">
										...
										<input type="text" name="lastName" class="form-control" id="bsValidation2" placeholder="Last Name" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="text" name="phoneNum" class="form-control" id="bsValidation3" placeholder="Phone" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="email" name="email" class="form-control" id="bsValidation4" placeholder="Email" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="password" name="password" class="form-control" id="bsValidation5" placeholder="Password" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="password" name="confirmPassword" class="form-control" id="bsValidation5" placeholder="Password" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="date" name="dob" class="form-control" id="bsValidation8" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<input type="text" name="city" class="form-control" id="bsValidation10" placeholder="City" required>
										<div class="invalid-feedback">
									...
									<div class="col-md-6">
										...
										<textarea class="form-control" name="address" id="bsValidation13" placeholder="Address ..." rows="1" required></textarea>
										<div class="invalid-feedback">
