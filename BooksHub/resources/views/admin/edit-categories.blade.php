              ...
              <div class="card">
                 <div class="card-body">
                   <div class="mb-4">
                      ...
                      <input type="text" name="title" value="{{$category->name}}" class="form-control" placeholder="write title here....">
                   </div>
                   <div class="mb-4">
                     <h5 class="mb-3">Description</h5>
                     <textarea class="form-control" name="description" cols="4" rows="6" placeholder="write a description here..">{{$category->description}}</textarea>
                   </div>
                </div>  
              </div>
          </div> 
