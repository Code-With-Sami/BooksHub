...
<div class="main-content">
      <!--breadcrumb-->
				...
				<!--end breadcrumb-->
        <form action="{{url('updateBooks', $book->id)}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="row">
              ...
              <div class="card">
                 <div class="card-body">
                   <div class="mb-4">
                      ...
                      <input type="text" name="title" class="form-control" value="{{$book->title}}" placeholder="write title here....">
                   </div>
                   <div class="mb-4">
                     <h5 class="mb-3">Book Description</h5>
                     <textarea class="form-control" name="description" cols="4" rows="6" placeholder="write a description here..">{{$book->description}}</textarea>
                   </div>
                   <div class="mb-4">
                    <h5 class="mb-3">Book Image</h5>
                    <img src="{{ asset('booksImages/'.$book->cover_image) }}" alt="" width="100" height="120">
                      ...
                      <div class="col-12 col-lg-9">
                        <div class="tab-content">
                          <div class="tab-pane fade" id="Pricing">
                            <div class="row g-3">
                              <div class="col-12 col-lg-12">
                                ...
                                <input class="form-control" type="number" name="price" value="{{$book->price}}"  placeholder="$$$">
                              </div>
                            </div>
                          </div>
                          <div class="tab-pane fade" id="Stock">
                            ...
                            <div class="row g-3">
                              <div class="col-sm-12">
                                <input class="form-control" type="number" name="stock_quantity" value="{{$book->stock_quantity}}"  placeholder="Quantity">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="tab-pane fade" id="Advanced">
                            ...
                            <div class="row g-3 mb-3">
                              ...
                              <div class="col-12 col-lg-6">
                                ...
                                <input class="form-control" type="text" name="isbn" value="{{$book->isbn}}" placeholder="ISBN Number">
                              </div>
                            </div>
                            <div class="row g-3">
                              <div class="col-12 col-lg-12">
                                <h6>Upload Book</h6>
                                <iframe src="{{ asset('booksPDF/'.$book->file_url) }}" width="100px" height="100px"></iframe>
                   ...
                   <h5 class="mb-3">Organize</h5>
                      <div class="row g-3">
                          <div class="col-12">
                            ...
                            <input type="text" name="author" class="form-control" id="author" value="{{$book->author}}" placeholder="Author">
                          </div>
                          <div class="col-12">
                          ...
                          <div class="col-12">
                            ...
                            <select class="form-select" name="format" id="format">
                              <option value="{{$book->format}}" selected >{{$book->format}}</option>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      <div class="col-12">
                        ...
                        <input type="text" name="language" class="form-control" id="language" value="{{$book->language}}" placeholder="language">
                       </div>
                      <div class="col-12">
                        <label for="pages" class="form-label">Pages</label>
                        <input type="text" name="pages" class="form-control" id="pages" value="{{$book->pages}}" placeholder="pages">
                       </div>
                       <div class="col-12">
                        <label for="publicationDate" class="form-label">Publication Date</label>
                        <input type="date" name="publication_date" class="form-control" value="{{$book->publication_date}}" id="publicationDate">
                       </div>
                      </div>
                  </div>
                 </div>
